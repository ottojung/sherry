...
(define-module (sherry create-file)
  ...
  :use-module ((sherry export-name-to-file-name) :select (export-name->file-name))
  :use-module ((sherry file-module-declaration) :select (file-module-declaration))
  :use-module ((sherry file-neighbours) :select (file-neighbours))
  :use-module ((sherry file-source-type) :select (file-source-type))
  :use-module ((sherry module-declaration-replace-exports) :select (module-declaration-replace-exports))
  :use-module ((sherry module-declaration-replace-name) :select (module-declaration-replace-name))
